package com.assignment.backend.constants;

public final class TourPackageApiConstants {
    private static final String BASE_TOUR_PACKAGE = BaseApiConstant.BASE_URL + "tour-package/";
